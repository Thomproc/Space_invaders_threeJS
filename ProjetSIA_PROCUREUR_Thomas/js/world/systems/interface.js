...
import hearthPng from "../../assets/images/heart.png";
...
class Interface {
  ...
  showEndScreen(HTML_title) {
    ...
    this.#endScreenSubTitles.innerHTML =
      "High score : " +
      config.highScore +
      "<br>" +
      "Score : " +
      config.score +
      "<p> Appuyer sur <b>ENTREE</b> pour revenir au menu </p>";
  ...
  updateGameScore() {
    this.#scoreGameDiv.innerHTML =
      "Score : " + config.score + "<br>" + "combo : " + config.scoreCombo;
  }
